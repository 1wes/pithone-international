...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axiosInstance
      .post("https://mail-projectsapi.onrender.com/pithone-mail", formInfo)
      .then(() => {
        setOverlay({
          ...overlay,
          show: true,
      ...
      .catch(() => {
        setOverlay({
          ...
          status: "Failed!",
          feedback:
            "Message not delivered. Please try again or contact support.",
        });
      });
                ...
                <div className="contact-info">
                  ...
                  <div className="contacts-list">
                    <ContactInfo icon={<HiBuildingOffice2 />}>
                      6<sup>th</sup> Floor, Kitamu House, Tubman Road, off
                    ...
                    <ContactInfo icon={<FaPhoneAlt />}>
                      ...
                      <div>
                        <Link to={`tel: +254 769 764 013`} target="_blank">
                          +254 769 764 013
                        </Link>
                      </div>
                    </ContactInfo>
  ...
  return (
    <Fragment>
      <div className="info">
        ...
        <span className="info-details">{children}</span>
      </div>
    </Fragment>
  );
};
